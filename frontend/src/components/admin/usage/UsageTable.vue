      ...
      >
        <template #cell-user="{ row }">
          <div class="text-sm">
            ...
            <span v-if="row.user?.username" class="ml-1 text-gray-500 dark:text-gray-400">{{ row.user.username }}</span>
            <span v-if="row.user_notes" class="ml-1 text-gray-500 dark:text-gray-400">{{ row.user_notes }}</span>
