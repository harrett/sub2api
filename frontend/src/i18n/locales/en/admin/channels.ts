export default {
    ...
    riskControl: {
      ...
      requestIdHint: 'Moderation logs do not store the upstream account; look this ID up in Ops error details to see which account served the request.',
      viewInErrorLogs: 'View error log (with account)',
