...
const (
	...
	SettingKeyBundleSubscriptionsEnabled          = "bundle_subscriptions_enabled"     // 跨平台共享额度订阅总开关（默认关闭）
	...
	SettingKeyHideKeyRateMultiplier       = "hide_key_rate_multiplier"      // 是否对普通用户隐藏 API 密钥页面的分组 x 倍率显示
