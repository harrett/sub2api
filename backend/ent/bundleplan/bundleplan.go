...
const (
	...
	// FieldSharedDailyLimitUsd holds the string denoting the shared_daily_limit_usd field in the database.
	FieldSharedDailyLimitUsd = "shared_daily_limit_usd"
	// FieldSharedMonthlyLimitUsd holds the string denoting the shared_monthly_limit_usd field in the database.
	FieldSharedMonthlyLimitUsd = "shared_monthly_limit_usd"
	...
	GroupsTable = "bundle_plan_groups"
	// GroupsInverseTable is the table name for the BundlePlanGroup entity.
	// It exists in this package in order to avoid circular dependency with the "bundleplangroup" package.
	GroupsInverseTable = "bundle_plan_groups"
	// GroupsColumn is the table column denoting the groups relation/edge.
	GroupsColumn = "bundle_plan_id"
	// SubscriptionsTable is the table that holds the subscriptions relation/edge.
	SubscriptionsTable = "bundle_subscriptions"
	// SubscriptionsInverseTable is the table name for the BundleSubscription entity.
	// It exists in this package in order to avoid circular dependency with the "bundlesubscription" package.
	SubscriptionsInverseTable = "bundle_subscriptions"
	// SubscriptionsColumn is the table column denoting the subscriptions relation/edge.
	SubscriptionsColumn = "bundle_plan_id"
)
...
var Columns = []string{
	...
	FieldValidityDays,
	FieldValidityUnit,
	FieldSharedDailyLimitUsd,
	FieldSharedMonthlyLimitUsd,
	FieldFeatures,
	FieldForSale,
	FieldSortOrder,
	FieldCreatedAt,
...
// BySharedDailyLimitUsd orders the results by the shared_daily_limit_usd field.
func BySharedDailyLimitUsd(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSharedDailyLimitUsd, opts...).ToFunc()
}

// BySharedMonthlyLimitUsd orders the results by the shared_monthly_limit_usd field.
func BySharedMonthlyLimitUsd(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSharedMonthlyLimitUsd, opts...).ToFunc()
}
