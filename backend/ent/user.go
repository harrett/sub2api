...
type UserEdges struct {
	...
	// BundleSubscriptions holds the value of the bundle_subscriptions edge.
	BundleSubscriptions []*BundleSubscription `json:"bundle_subscriptions,omitempty"`
...
// BundleSubscriptionsOrErr returns the BundleSubscriptions value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) BundleSubscriptionsOrErr() ([]*BundleSubscription, error) {
	if e.loadedTypes[3] {
		return e.BundleSubscriptions, nil
	}
	return nil, &NotLoadedError{edge: "bundle_subscriptions"}
}
...
// QueryBundleSubscriptions queries the "bundle_subscriptions" edge of the User entity.
func (_m *User) QueryBundleSubscriptions() *BundleSubscriptionQuery {
	return NewUserClient(_m.config).QueryBundleSubscriptions(_m)
}
